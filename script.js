...
function updateUI() {
    ...
    transactions.forEach((t, index) => {
        ...
        li.innerHTML = `<span class="desc">${t.desc}</span>
    ...
    balanceEl.style.color = balance > 0 ? "green" : balance < 0 ? "red" : "#01040aff"
}
...
authBtn.addEventListener('click', () => {
    ...
    if (isLoginMode) {
        if (!users[username]) { alert("User not found. Please sign up."); return }
